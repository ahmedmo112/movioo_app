...
class DetailScreen extends StatelessWidget {
  DetailScreen({Key? key,required this.image,required this.id,}) : super(key: key);
      ...
      child: BlocConsumer<AppCubit,AppState>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: state is GetMovieSuccessState ?  SingleChildScrollView(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text((cubit.detailModel!.voteAverage!/2).toString(),
                          style:
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ListView.separated(
                          itemCount: cubit.detailModel!.productionCompanies!.length,
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return cubit.detailModel!.productionCompanies![index].logoPath! != ""? Container(
                                height: 50,
                                width: 50,
                                decoration: BoxDecoration(
                                    color: Colors.white,
                                    ...
                                    image: DecorationImage(
                                        image: NetworkImage(
                                            IMAGE+cubit.detailModel!.productionCompanies![index].logoPath!),
