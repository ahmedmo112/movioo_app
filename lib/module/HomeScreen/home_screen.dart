      ...
      child: BlocConsumer<AppCubit,AppState>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
              ...
              body: state is !GetUpcomingMovieLoadingState? Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      HomeSliderWidget(images: data.slider!,text: data.text!,),
                      ...
                      SectionWidget(moviedate: data.popularMovieList!,data:data),
                      const SizedBox(
                        height: 10,
                      ),
                     ...
                     SectionWidget(moviedate: data.topRatedMovieList!,data:data),
                      const SizedBox(
                        height: 10,
                      ),
                      const Text("Upcoming",
                      ...
                      SectionWidget(moviedate: data.upcomingMovieList!,data:data),
                    ],
                  ),
                ),
              ):LoadingDataScreen());
